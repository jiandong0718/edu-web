      ...
      // 系统管理
      {
        ...
        children: [
          ...
          },
          {
            path: 'classroom',
            lazy: async () => ({
              Component: (await import('@/pages/system/Classroom')).default
            }),
          },
          {
            path: 'config',
            lazy: async () => ({
              Component: (await import('@/pages/system/Config')).default
            }),
          },
          {
            path: 'holiday',
            lazy: async () => ({
              Component: (await import('@/pages/system/Holiday')).default
            }),
          },
          {
            path: 'login-log',
            lazy: async () => ({
              Component: (await import('@/pages/system/LoginLog')).default
            }),
          },
          {
            path: 'operation-log',
            lazy: async () => ({
              Component: (await import('@/pages/system/OperationLog')).default
            }),
          },
        ],
      },
      ...
      // 教学管理
      {
        ...
        children: [
          ...
          },
          {
            path: 'course-package',
            lazy: async () => ({
              Component: (await import('@/pages/teaching/coursePackage')).default
            }),
          },
          {
            path: 'class',
