  ...
  const errorColumns: ColumnsType<{ row: number; message: string }> = [
    {
      ...
      key: 'row',
      width: 100,
      render: (text: number) => <span style={{ color: '#fff' }}>第 {text} 行</span>,
    },
    {
      title: '错误信息',
      dataIndex: 'message',
    ...
    <div>
      ...
      <div style={styles.stepCard}>
        <Steps current={currentStep}>
          <Step title="上传文件" description="选择要导入的 Excel 文件" />
        ...
        <Alert
          ...
          description={
            <div>
              ...
              <p>2. 必填字段：姓名、手机号、家长姓名、家长电话、性别、线索来源、所属校区</p>
              <p>3. 性别填写：男 或 女</p>
              <p>4. 线索来源填写：线上、线下、转介绍、活动、其他</p>
        ...
        <Card style={styles.card} bordered={false}>
          <Upload.Dragger {...uploadProps}>
            <div style={styles.uploadArea}>
              ...
              <div style={styles.uploadHint}>支持 .xlsx 和 .xls 格式，文件大小不超过 10MB</div>
            </div>
          </Upload.Dragger>
        </Card>
      )}
