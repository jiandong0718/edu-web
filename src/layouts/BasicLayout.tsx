...
const menuItems: MenuProps['items'] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: '/system/classroom', label: '教室管理' },
      { key: '/system/config', label: '系统配置' },
      { key: '/system/holiday', label: '假期管理' },
      { key: '/system/login-log', label: '登录日志' },
      { key: '/system/operation-log', label: '操作日志' },
    ],
  },
  {
    key: '/notification',
  ...
  },
  {
    ...
    children: [
      ...
      { key: '/student/tag', label: '学生标签' },
      { key: '/student/import', label: '学生导入' },
    ],
  },
  {
    key: '/teaching',
    ...
    children: [
      ...
      { key: '/teaching/course-category', label: '课程分类' },
      { key: '/teaching/course-package', label: '课程套餐' },
      { key: '/teaching/teacher', label: '教师管理' },
  ...
  },
  {
    ...
    children: [
      ...
      { key: '/marketing/lead-import', label: '线索导入' },
      { key: '/marketing/lead-assign', label: '线索分配' },
